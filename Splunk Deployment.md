  ...
  <row>
    <panel>
      <table>
        ...
        <search>
          <query>index=linux sourcetype=linux_secure host="*" | transaction pid startswith="session opened" | regex _raw!="session closed" | table _time user</query>
          <earliest>-7d@h</earliest>
          <latest>now</latest>
    ...
    <panel>
      <table>
        ...
        <search>
          <query>index=linux sourcetype=linux_secure host="*" | transaction pid maxevents=3 endswith="session closed" | eval HHMMSS=tostring(duration, "duration") | table _time user dvc HHMMSS</query>
          <earliest>$field2.earliest$</earliest>
          <latest>$field2.latest$</latest>
          <sampleRatio>1</sampleRatio>
        </search>
  ...
  <row>
    <panel>
      <table>
        ...
        <search>
          <query>index=linux sourcetype=bash_history host="*" | table _time, user_name, bash_command | sort - _time</query>
          <earliest>$field2.earliest$</earliest>
          <latest>$field2.latest$</latest>
          <sampleRatio>1</sampleRatio>
        </search>
  ...
  <row>
    <panel>
      <table>
        ...
        <search>
          <query>index=linux sourcetype=bash_history host="*" bash_command="./*" OR bash_command="sh *"</query>
          <earliest>-7d@h</earliest>
          <latest>now</latest>
          <sampleRatio>1</sampleRatio>
        </search>
    ...
    <panel>
      <table>
        ...
        <search>
          <query>index=linux sourcetype=*.bash_history  (sh OR ./)| table _time user_name host bash_command | sort - _time</query>
          <earliest>$field2.earliest$</earliest>
          <latest>$field2.latest$</latest>
          <sampleRatio>1</sampleRatio>
        </search>
  ...
  <row>
    <panel>
      ...
      <table>
        ...
        <search>
          <query>sourcetype=bash_history | stats count(bash_command) by user_name host</query>
          <earliest>-7d@h</earliest>
          <latest>now</latest>
        </search>
        <option name="drilldown">none</option>
